<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProvePage.aspx.cs" Inherits="ApproveOneNote.ProvePage" %>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <p class="text-center"> <asp:Label ID="link_provepage" class="text-center display-3 text-primary" runat=server ><a class="text-center" href="https://1drv.ms/f/s!AuNVm_M1dypZaBhSKlJUVKchH_U" target=_blank >www.cnc.approve.onenote</a> </asp:Label></p>
